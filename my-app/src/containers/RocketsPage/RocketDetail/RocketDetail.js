...
const RocketDetail = ({ match }) => {
  ...
  return (
    <>
      {/* Entrie Screen */}
      <div className="bg-gray-200 sm:flex sm:flex-flow">
        <div className="m-2 mt-4 sm:flex justify-center">
          <button
            type="button"
            onClick={() => history.push('/launches')}
            className="focus:outline-none h-12 mt-3 mr-4 text-white text-lg py-2.5 px-5 rounded-md bg-gray-700 hover:bg-gray-900 hover:shadow-lg"
          >
            &#10094;
          </button>
          {/* Left Panel */}
          <div className="h-auto lg:w-7/12 xl:w-1/4">
            <div className="h-1/6 sm:m-2 mt-2">
              {/* First Block */}
            ...
            {/* Second Block */}
            <div className="p-5 sm:mt-5 sm:m-2 rounded-lg shadow-md bg-white">
            ...
            <div className="p-5 mt-3 sm:m-2 rounded-lg shadow-md bg-white">
          ...
          {/* Center Panel */}
          <div className="h-auto  flex-col justify-center mt-3 w-full lg:w-7/12 xl:w-2/5">
          ...
          {/* Right Panel */}
          <div className="w-full sm:m-2 lg:w-7/12 xl:w-1/4 h-auto mt-3">
            <div className="h-1/6">
              {/* First Block */}
            ...
            {/* Second Block */}
            <div className="p-5 sm:mt-5 rounded-lg shadow-md bg-white">
              ...
              <div className="m-3 mx-auto border-t p-2 px-0 py-3.5 text-sm font-serif">
                ...
                <ol className="p-2 text-md font-sans font-semibold" type="1">
                  ...
                  <li>
                    Vacuum{' '}
                    {rocket?.engines?.thrust_vacuum?.kN ?? 'thrust_vacuum'} kN
                  </li>
                  <li>
                    Thrust to weight{' '}
              ...
              <div className="m-3 mx-auto border-t p-2 px-0 py-3.5 text-sm font-serif">
                ...
                <ol className="p-2 text-sm font-sans font-semibold" type="1">
                  ...
                  <li>
                    Burn Time {rocket?.second_stage?.burn_time_sec ?? '-'}{' '}
                    sec(s)
                  </li>
                </ol>
              </div>
