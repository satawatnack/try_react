    ...
    return(
        ...
        <div className="bg-red-500 w-screen h-screen flex">
            <div className="bg-green-500 w-1/4 h-screen">
                ...
                <div className="p-8 text-center font-serif font-bold">{rocket.rocket_name}</div>
                </div>
                <div className="p-5">
                <div className="m-3 mx-auto border-t p-2 px-0 py-3.5 text-cen">First Flight: {rocket.first_flight}</div>
                {/* <div className="m-3 mx-auto border-t p-2 px-0 py-3.5 text-cen">Height: {rocket.height.meters} meters</div>
                <div className="m-3 mx-auto border-t p-2 px-0 py-3.5 text-cen">Diameter: {rocket.diameter.meters} meter</div>
                <div className="m-3 mx-auto border-t p-2 px-0 py-3.5 text-cen">Mass: {rocket.mass.kg} Kilograms</div> */}
                </div>
            </div>
